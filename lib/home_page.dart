                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: NetworkImage(
                                        items.data.itemImage.first.fileName),
                                    fit: BoxFit.cover)),
                          ),
                          Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount: items.data.itemReview.length,
                                  ...
                                  return Column(
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          RatingBarIndicator(
                                            rating: double.parse(items
                                                .data.itemReview[index].rating),
                                            itemBuilder: (context, index) =>
                                                const Icon(
                                              Icons.star,
                                              color: Colors.amber,
                                      ...
                                      SizedBox(
                                        width: double.infinity,
                                        child: Text(
                                          items.data.itemReview[index].content,
                                          style: const TextStyle(
                                            color: Color(0xFF626262),
                                            fontSize: 16,
                                            fontFamily: 'Avenir',
